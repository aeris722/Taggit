(function () {
  ...
  function createPrompt(conversation, examples = []) {
    ...
    return [
      ...
      "Output exactly these seven sections:",
      "",
      ...
      "Relationship summary: 1-2 sentences about who this person is to the user and why they matter.",
      "Key topics: 3-6 concise topics separated by commas.",
      "Goals: the other person's apparent goals, or 'Unknown'.",
      "Interests: their apparent interests, or 'Unknown'.",
      "Open threads: unresolved questions, promises, asks, or follow-ups, or 'None'.",
      "Suggested next action: one specific action the user should take next.",
